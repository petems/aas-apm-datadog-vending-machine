    ...
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600 mb-6">
          This component is being redesigned to address MSAL authentication
          challenges
        </p>
      </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                The original MSAL-based authentication system has been removed
                due to compatibility issues with hosted multi-tenant Azure AD
                applications.
              </p>
            </div>
          </div>
      ...
      <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <div className="text-sm text-blue-800 space-y-2">
          <p>
            <strong>Multi-Tenant Application Issues:</strong> When deployed to
            hosting platforms, the application is considered "untrusted" by
            Azure AD, causing authentication flows to fail.
          </p>
          <p>
            <strong>Publisher Domain Verification:</strong> Azure AD requires
            verified publisher domains for production apps, which is complex to
            achieve for hosted applications without a custom domain.
          </p>
          <p>
            <strong>Redirect URI Restrictions:</strong> Azure AD has strict
            requirements for redirect URIs that must match the application's
            domain exactly, making development and deployment challenging.
          </p>
        </div>
      </div>

      <div className="mt-6 text-center">
        <p className="text-sm text-gray-500">Expected completion: TBC</p>
      </div>
    </div>
  );
};
