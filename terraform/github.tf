...
resource "github_actions_secret" "react_app_client_id" {
  ...
  plaintext_value = azuread_application.datadog_vending_machine.application_id
}
...
REACT_APP_CLIENT_ID=${azuread_application.datadog_vending_machine.application_id}
